...
set LauncherMod=echoes
set FullGameName=Half-Life : Echoes
set ShortGameName=Echoes

for /f "delims=" %%a in ('"tools\SteamAppsLocation" 70 InstallDir') do set GameDir=%%a
...
xcopy "%~dp0Build\echoes" "%GameDir%\%LauncherMod%" /y /e
