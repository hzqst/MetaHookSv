...
call cmake -G "Visual Studio 17 2022" -S "%SolutionDir%thirdparty\SDL3" -B "%SolutionDir%thirdparty\build\SDL3\x86\Release" -A Win32 -DCMAKE_INSTALL_PREFIX="%SolutionDir%thirdparty\install\SDL3\x86\Release" -DCMAKE_TOOLCHAIN_FILE="%SolutionDir%tools\toolchain.cmake"  -DCMAKE_POLICY_VERSION_MINIMUM=3.5
