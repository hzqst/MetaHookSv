...
call cmake -S "%SolutionDir%thirdparty\zlib-fork" -B "%SolutionDir%thirdparty\build\zlib\x86\Debug" -A Win32 -DCMAKE_INSTALL_PREFIX="%SolutionDir%thirdparty\install\zlib\x86\Debug" -DCMAKE_TOOLCHAIN_FILE="%SolutionDir%tools\toolchain.cmake" -DZLIB_BUILD_TESTING=FALSE -DUSE_VCLTL=TRUE
