...
call cmake -S "%SolutionDir%thirdparty\SDL2-compat" -B "%SolutionDir%thirdparty\build\SDL2-compat\x86\Debug" -A Win32 -DCMAKE_INSTALL_PREFIX="%SolutionDir%thirdparty\install\SDL2-compat\x86\Debug" -DCMAKE_PREFIX_PATH="%SolutionDir%thirdparty\install\SDL3\x86\Debug" -DCMAKE_TOOLCHAIN_FILE="%SolutionDir%tools\toolchain.cmake"  -DSDL2COMPAT_TESTS=FALSE -DSDL2COMPAT_INSTALL_SDL3=TRUE

call cmake --build "%SolutionDir%thirdparty\build\SDL2-compat\x86\Debug" --config Debug --target install