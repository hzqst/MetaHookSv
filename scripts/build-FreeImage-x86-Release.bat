...
call cmake -S "%SolutionDir%thirdparty\FreeImage_clone" -B "%SolutionDir%thirdparty\build\FreeImage\x86\Release" -A Win32 -DCMAKE_PREFIX_PATH="%SolutionDir%thirdparty\install\zlib\x86\Release" -DCMAKE_INSTALL_PREFIX="%SolutionDir%thirdparty\install\FreeImage\x86\Release" -DCMAKE_TOOLCHAIN_FILE="%SolutionDir%tools\toolchain.cmake" -DUSE_VCLTL=TRUE
