...
#ifndef TEXTENTRY_LEGACY_H
#define TEXTENTRY_LEGACY_H
...
#include <vgui/VGUI.h>
#include <Color.h>
#include <vgui_controls_legacy/Panel_Legacy.h>
...
class TextEntry_Legacy : public Panel_Legacy
{
	DECLARE_CLASS_SIMPLE( TextEntry_Legacy, Panel_Legacy );

public:
	TextEntry_Legacy(Panel_Legacy *parent, const char *panelName);
	virtual ~TextEntry_Legacy();
