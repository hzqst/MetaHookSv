...
#ifndef RICHTEXT_LEGACY_H
#define RICHTEXT_LEGACY_H
...
class RichText_Legacy : public Panel_Legacy
{
	DECLARE_CLASS_SIMPLE( RichText_Legacy, Panel_Legacy );

public:
	RichText_Legacy(Panel *parent, const char *panelName);
	~RichText_Legacy();
