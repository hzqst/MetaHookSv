...
- Verification: regression tests execute the real handlers with mocked GL and cover ordinary forwarding, two different portal textures, nonzero copy source y, unrelated copies, empty lists, early return, exception cleanup, separate read/draw bindings, viewport and scene/context restoration. Renderer Release and Release_AVX2 Win32 builds exited 0. Game runtime and visual verification remain outstanding.
