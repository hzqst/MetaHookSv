...
#define LOAD_FLAGS_NO_EXECUTE						0x00000020

#define LOAD_FLAGS_READ_ONLY						0x00000040

#define LOAD_FLAGS_NO_RESOLVE_IMPORTS				0x00000080
...
NTSTATUS NTAPI LdrLoadDllMemoryExW(
	...
	_In_ SIZE_T BufferSize,					// BufferSize, ImageSize will be auto-detected if BufferSize=0 is used
