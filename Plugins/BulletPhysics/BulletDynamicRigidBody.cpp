...
bool CBulletDynamicRigidBody::SetupJiggleBones(CRagdollObjectSetupBoneContext *Context)
{
	...
	if (pMotionState->IsBoneBased())
	{
		...
		{
			gEngfuncs.Con_DPrintf("CBulletDynamicRigidBody::SetupJiggleBones invalid m_boneindex!");
			return false;
		}
