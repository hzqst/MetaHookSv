...
#define STUDIO_DEPTH_TEXTURE_ENABLED			0x400000000000ull
...
#define STUDIO_STENCIL_NO_GLOW_BLUR_ENABLED		0x8000000000000ull
#define STUDIO_STENCIL_NO_GLOW_COLOR_ENABLED	0x10000000000000ull
#define STUDIO_GLOW_COLOR_ENABLED				0x20000000000000ull
#define STUDIO_MULTIVIEW_ENABLED				0x40000000000000ull
#define STUDIO_LINEAR_DEPTH_ENABLED				0x80000000000000ull
