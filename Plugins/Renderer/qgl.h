...
extern void (APIENTRY *qglTexImage3D)(GLenum target, GLint level, GLint internalFormat, GLsizei width, GLsizei height, GLsizei depth, GLint border, GLenum format, GLenum type, const GLvoid * data);
...
extern PFNGLFRAMEBUFFERTEXTURELAYEREXTPROC qglFramebufferTextureLayerEXT;
...
extern PFNGLUNIFORMMATRIX4FVARBPROC qglUniformMatrix4x3fvARB;
extern PFNGLUNIFORMMATRIX4FVARBPROC qglUniformMatrix3x4fvARB;
