...
#define STUDIO_CLIP_BONE_ENABLED				0x200000000000ull
#define STUDIO_LEGACY_DLIGHT_ENABLED			0x400000000000ull
#define STUDIO_LEGACY_ELIGHT_ENABLED			0x800000000000ull
